    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.contentContainer}>
        <View style={styles.headerRow}>
          <View>
            <Text style={styles.crumb}>Academic Plan</Text>
            <Text style={styles.title}>Planner Detail</Text>
          </View>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Number Sense Unit</Text>
          <Text style={styles.cardMeta}>Grade 1 · Mathematics · Sep 01 - Sep 12</Text>
          <View style={styles.statsRow}>
            <View style={styles.statBox}><Text style={styles.statValue}>40%</Text><Text style={styles.statLabel}>Progress</Text></View>
            <View style={styles.statBox}><Text style={styles.statValue}>12</Text><Text style={styles.statLabel}>Lessons</Text></View>
            <View style={styles.statBox}><Text style={styles.statValue}>On Track</Text><Text style={styles.statLabel}>Status</Text></View>
          </View>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Planning Sequence</Text>
          <Text style={styles.detailText}>Concept launch</Text>
          <Text style={styles.detailText}>Guided fluency tasks</Text>
          <Text style={styles.detailText}>Assessment review</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
